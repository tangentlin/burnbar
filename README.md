...
<!-- LATEST_DMG_LINK -->
[**⬇️ Download for Mac (Apple Silicon) — v0.6.0**](https://github.com/tangentlin/burnbar/releases/download/v0.6.0/Burnbar-0.6.0-arm64.dmg) · [All releases](https://github.com/tangentlin/burnbar/releases/latest)
