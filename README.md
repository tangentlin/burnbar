...
<!-- LATEST_DMG_LINK -->
[**⬇️ Download for Mac (Apple Silicon) — v0.4.1**](https://github.com/tangentlin/burnbar/releases/download/v0.4.1/Burnbar-0.4.1-arm64.dmg) · [All releases](https://github.com/tangentlin/burnbar/releases/latest)
