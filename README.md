...
<!-- LATEST_DMG_LINK -->
[**⬇️ Download for Mac (Apple Silicon) — v0.5.0**](https://github.com/tangentlin/burnbar/releases/download/v0.5.0/Burnbar-0.5.0-arm64.dmg) · [All releases](https://github.com/tangentlin/burnbar/releases/latest)
