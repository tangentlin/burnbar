...
<!-- LATEST_DMG_LINK -->
[**⬇️ Download for Mac (Apple Silicon) — v0.7.0**](https://github.com/tangentlin/burnbar/releases/download/v0.7.0/Burnbar-0.7.0-arm64.dmg) · [All releases](https://github.com/tangentlin/burnbar/releases/latest)
