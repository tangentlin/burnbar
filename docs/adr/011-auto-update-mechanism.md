...
| Native OS notification instead of / in addition to the tray row | Adds a second UI surface and a permissions prompt for a single-purpose, low-frequency signal; the always-visible tray row already covers it without extra chrome. |
